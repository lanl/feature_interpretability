...
``python feature_sensitivity.py -P pytorch -E nestedcylinder -M ../examples/pyt_nestedcyl/trained_hrMOICyl2sclPTW_model.pth -IF hr_MOICyl -ID ../examples/pyt_nestedcyl/data/ -L interpActivations.14 -T Grid -NM ft01 -XK idx00130 -S ../examples/pyt_nestedcyl/figures/``
