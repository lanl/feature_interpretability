...
``python feature_fieldstd_corr.py -P pytorch -E nestedcylinder -M ../examples/pyt_nestedcyl/trained_hrMOICyl2sclPTW_model.pth -IF hr_MOICyl -ID ../examples/pyt_nestedcyl/data/ -L interpActivations.14 -T All -NM ft01 -F All -S ../examples/pyt_nestedcyl/figures/``
"""
